...
class ApiEndPoint {
    ...
    companion object {
        private var IP_ADDRESS = "192.168.1.8"  // Dynamic IP_ADDRESS: Match with current machine IPv4 Address
        private val SERVER = "http://$IP_ADDRESS/contactin/api/"

        var USER_CREATE_ACCOUNT = SERVER+"user_create_account.php"  // CreateAccount
        var USER_READ_ACCOUNT = SERVER+"user_read_account.php"  // UserLogin, DataPrep().fetchUserData()
        ...
        var CONTACT_READ_CONTACT = SERVER+"contact_read_contact.php"  // MainContactList.fetchContacts() (fragment), DataPrep().fetchContactData()
